                      ...
                      <tbody>
                        {orderHistory.map((order) => (
                          <tr key={order.id} className="border-b border-gray-100">
                            <td className="px-2 py-2 text-sm text-gray-900">{order.po_number}</td>
                            <td className="px-2 py-2 text-sm text-gray-900">{order.date}</td>
                            <td className="px-2 py-2 text-sm text-gray-900">₱{order.total.toLocaleString()}</td>
                          </tr>
                        ))}
